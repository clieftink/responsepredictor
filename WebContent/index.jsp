...
<body style="margin:0;overflow:hidden" onload="OnLoadIndex();initRpInterface();" onresize="OnResizeIndex()" onmouseup="OnMouseUpBar()" onmousemove="return OnMouseMoveBar(event);">
...
<!-- Header -->
<div id="divHeader" style="width:100%;height:5px">
</div>
